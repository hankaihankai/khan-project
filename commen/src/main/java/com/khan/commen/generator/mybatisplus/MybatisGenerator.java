package com.khan.commen.generator.mybatisplus;
...
public class MybatisGenerator {
	...
	public static void main(String[] args) {
		...
		gc.setOutputDir(projectPath + subProject + "/src/main/java");
		gc.setAuthor("khan");
		gc.setOpen(false);
		...
		focList.add(new FileOutConfig(templatePath) {
			...
			public String outputFile(TableInfo tableInfo) {
				...
				return projectPath + subProject + "/src/main/resources/mapper/" + tableInfo.getEntityName() + "Mapper" + StringPool.DOT_XML;
			}
		});
        /*
